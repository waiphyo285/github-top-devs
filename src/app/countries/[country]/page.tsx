          ...
          <form method="GET" className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="relative flex-1 flex items-center">
              ...
              <input
                ...
                className="w-full bg-secondary/60 border border-border/60 rounded-lg py-2.5 pl-10 pr-4 text-sm focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary placeholder:text-muted-foreground/70"
              />
            </div>
            <div className="flex gap-2">
              <Button type="submit" className="px-6 bg-primary text-primary-foreground hover:bg-primary/90 font-bold rounded-lg shadow-sm text-xs">
                Search Country
              </Button>
              {search && (
                <Link
          ...
          <thead>
            <tr className="border-b border-border/30 bg-card/30 text-xs font-mono uppercase tracking-wider text-muted-foreground">
              ...
              <th className="py-4 px-6 font-medium w-24 text-center">
                <SortLink column="globalRank" label="Global" />
              </th>
