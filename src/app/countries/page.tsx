  ...
  const SortLink = ({ column, label }: { column: typeof sortBy; label: string }) => {
    ...
    return (
      <Link
        ...
        className={`inline-flex items-center gap-1.5 hover:text-primary transition-colors text-xs font-semibold px-3 py-1.5 rounded-lg border ${
          isActive
    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center space-x-2">
          ...
          <SortLink column="developerCount" label="Developer Count" />
          <SortLink column="name" label="Alphabetical" />
        </div>
      </div>
