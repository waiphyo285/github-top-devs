    ...
    <div className="space-y-16 pb-12">
      ...
      <section className="relative overflow-hidden rounded-3xl border border-border/30 bg-gradient-to-b from-card/80 to-background p-8 md:p-16 shadow-[0_0_50px_rgba(16,185,129,0.05)] text-center max-w-5xl mx-auto">
        ...
        <div className="relative z-10 space-y-6">
          <div className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-3 py-1 text-xs font-medium text-primary mb-2 shadow-[0_0_15px_rgba(16,185,129,0.1)]">
            <Sparkles className="h-3.5 w-3.5" />
            <span>GitHub Top Developers Database</span>
          </div>
        ...
        <div className="space-y-6 lg:col-span-2">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-bold tracking-tight text-foreground flex items-center gap-2">
              ...
              <span>Global Leaderboard Preview</span>
            </h3>
