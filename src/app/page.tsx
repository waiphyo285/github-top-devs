    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center py-20">
        ...
        <p className="text-muted-foreground mt-2">
          Data is being prepared. If this takes too long, check build logs.
        </p>
      </div>
    );
  }
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            return (
              <Card
                key={idx}
                className="border-border/40 bg-card/40 backdrop-blur-sm overflow-hidden hover:border-primary/20 transition-all group"
              >
              ...
              >
                <div className="flex items-center space-x-4 min-w-0">
                  ...
                  <Link
                    ...
                    className="relative h-10 w-10 shrink-0 overflow-hidden rounded-full border border-border/60 hover:border-primary transition-all"
                  >
                    <Avatar
                      src={dev.avatarUrl}
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <div className="flex flex-col items-end">
                    ...
                    <span className="text-sm font-bold text-foreground font-mono">
                      {(
                        dev.publicContributions + dev.privateContributions
                      ).toLocaleString()}
                    </span>
                  </div>
      ...
      <section className="border-t border-border/20 pt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          ...
          return (
            <div
              key={index}
              className="space-y-3 p-5 rounded-2xl bg-card/25 border border-border/20 hover:border-primary/20 transition-all"
            >
              ...
              <div className="pt-2">
                <Link
                  ...
                  className={buttonVariants({
                    ...
                    size: "sm",
                    className:
                      "p-0 text-primary hover:text-primary/80 inline-flex items-center gap-1",
                  })}
                >
